...
/**
 * A Positional Posting object that contains the document ID of a term as well
 * as a list of the positions of the term in the specified document ID.
 */
public class PositionalPosting {
	...
	private int docId;
	/**
	 * The list of positions of the term associated with this PositionalPosting in
	...
	private boolean comparePositions(PositionalPosting other) {
		...
		if (other.getPositions().size() != other.getPositions().size())
			return false;
